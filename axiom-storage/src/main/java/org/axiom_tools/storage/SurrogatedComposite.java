...
/**
 * A composition of surrogated items, some of whose components are held in maps or sets.
 */
public interface SurrogatedComposite extends SurrogatedItem {

    /**
     * Returns any maps that contain surrogated components. Due to the limitations of generic maps, their actual type
    ...
    /**
     * Returns any sets that contain surrogated components. Due to the limitations of generic sets, their actual type
     * signatures are erased. The framework used to save the components contained in the maps will determine their
     * actual types.
     *
